...
function showGrids() {
  ...
  Coordinates.drawGrid({size:100,scale:1,orientation:"z"}, scene);
  Coordinates.drawAxes({axisLength:4,axisOrientation:"x",axisRadius:0.02}, scene);
  Coordinates.drawAxes({axisLength:3,axisOrientation:"y",axisRadius:0.02}, scene);
}
function addToDOM() {
